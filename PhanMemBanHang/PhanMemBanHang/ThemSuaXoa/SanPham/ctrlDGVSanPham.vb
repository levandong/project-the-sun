...
#Region "Phân Trang"
    ...
    Private Sub btnQuaPhaiTatCa_Click(sender As Object, e As EventArgs) Handles btnQuaPhaiTatCa.Click
        If rlsKetQua IsNot Nothing Then
    ...
    Private Sub txtSoDongTrenMotTrang_KeyPress(sender As Object, e As KeyPressEventArgs) Handles txtSoDongTrenMotTrang.KeyPress
        If rlsKetQua IsNot Nothing Then
    ...
    Public Sub TinhToanTonkho()
        ...
        Next
    End Sub
    Private Sub ctrlDGVSanPham_Load(sender As Object, e As EventArgs) Handles Me.Load
