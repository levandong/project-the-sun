Public Class frmThemPhieuChi
    ...
    Sub CapNhatPhieuUyNhiemChi(PhieuChi As tbPhieuChi)
        ...
        cmbNhanVien.DataSource = From itm In dt.tbNhanViens
                                 Select itm
        cmbNhanVien.SelectedItem = PhieuChi
    ...
    Private Sub btnThem_Click(sender As Object, e As EventArgs) Handles btnThem.Click
        ...
        If _isSuaPhieu = False Then
            ...
            With newPhieu
                ...
                .idLoaiPhieuChi = dt.tbLoaiPhieuChis.Single(Function(s) s.Loai = -1).id
            End With
    ...
    Private Sub frmThemPhieuChi_FormClosing(sender As Object, e As FormClosingEventArgs) Handles MyBase.FormClosing
        undoChange()
    End Sub

    Private Sub frmThemPhieuChi_KeyDown(sender As Object, e As KeyEventArgs) Handles MyBase.KeyDown
    ...
    Private Sub frmThemPhieuChi_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        cmbNhanVien.DataSource = From itm In dt.tbNhanViens Order By itm.TenNhanVien
    ...
    Private Sub txtMaVach_KeyPress(sender As Object, e As KeyPressEventArgs) Handles vndSoTien.KeyPress, vndPhi.KeyPress, txtLyDo.KeyPress, dtpNgayChi.KeyPress, cmbNhanVien.KeyPress, cmbNganHang.KeyPress
    ...
    Private Sub dtpNgayNiemYet_KeyPress(sender As Object, e As KeyPressEventArgs) Handles dtpNgayChi.KeyPress
        ...
        End If
    End Sub
    Private Sub myComboBox_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmbNhanVien.GotFocus, cmbNganHang.GotFocus
