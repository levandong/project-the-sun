Public Class ctrlSuaPhieuNhap
    ...
    Public Sub SuaPhieuBaoGia(PhieuNhap As tbPhieuNhap)
        ...
        If PhieuNhap.tbNhanVien1 IsNot Nothing Then
            cmbNhanVienNhan.SelectedItem = PhieuNhap.tbNhanVien1
        End If
        txtTenCongTrinh.Text = PhieuNhap.TenCongTrinh.Trim
...
#Region "CẬP NHẬT SỐ PHIẾU"
    ...
    Private Function DongYSuaPhieu() As tbPhieuNhap
        ...
        With SuaPhieuNhap
            ...
            .GhiChu = txtTenCongTrinh.Text.Trim
...
#End Region
    ...
    Private Sub txtGhiChu_KeyPress(sender As Object, e As KeyPressEventArgs) Handles txtTenCongTrinh.KeyPress, txtKhachHang.KeyPress, cmbLoaiBaoGia.KeyPress, nudKhoiLuongRieng.KeyPress, cmbNguoiLienHe.KeyPress
        If e.KeyChar = Convert.ToChar(Keys.Enter) Then
            SendKeys.Send("{TAB}")
        End If
    End Sub

    Private Sub txtKhachHang_Enter(sender As Object, e As EventArgs) Handles txtKhachHang.Enter, txtTenCongTrinh.Enter
    ...
    Private Sub PhiếuNhậpToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles PhiếuNhậpToolStripMenuItem.Click
        DongYSuaPhieu()
        Dim vPhieuXuat As vwPhieuNhap = dt.vwPhieuNhaps.Single(Function(s) s.id = SuaPhieuNhap.id)
