...
Public Class frmDanhSachSanPhamXuat
    ...
    Private Sub frmInPhieuXuatNhapNguyenLieu_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Try
            strReport = dt.tbReports.First(Function(s) s.FileRDLC = ".\Report\PhieuXuat\rptDanhSachSanPhamXuat.rdlc").FileRDLC
        Catch
            strReport = ".\Report\PhieuXuat\rptDanhSachSanPhamXuat.rdlc"
        End Try
        ...
        ReportViewer1.LocalReport.SetParameters(DanhSachThamSo(NgayLap, TongTien))
